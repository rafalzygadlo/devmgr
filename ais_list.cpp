...
void CAisList::GetPanel()
{
	...
	m_FontSize = new wxSlider(Scroll,ID_FONT_SIZE,0,0,1,wxDefaultPosition,wxDefaultSize);
	...
	m_ViewNameScale = new wxSlider(Scroll,ID_VIEW_NAME_SCALE,0,0,1,wxDefaultPosition,wxDefaultSize);
	...
	FlexSizer->Add(TextClassA,0,wxALL|wxALIGN_CENTER_VERTICAL,2);
	FlexSizer->AddSpacer(1);
	FlexSizer->AddSpacer(1);
	...
	m_ShipColor0A = new wxColourPickerCtrl(Scroll,ID_SHIP_COLOR_0A,*wxBLACK,wxDefaultPosition,wxDefaultSize);
	color.Set(GetColor(SHIP_COLOR_0A).R,GetColor(SHIP_COLOR_0A).G,GetColor(SHIP_COLOR_0A).B,GetColor(SHIP_COLOR_0A).A);
	m_ShipColor0A->SetColour(color);
	FlexSizer->Add(m_ShipColor0A,0,wxALL,2);
	m_ShipAlpha0A = new wxSlider(Scroll,ID_SHIP_ALPHA_0A,0,0,1,wxDefaultPosition,wxDefaultSize);
	...
	m_ShipColor1A = new wxColourPickerCtrl(Scroll,ID_SHIP_COLOR_1A,*wxBLACK,wxDefaultPosition,wxDefaultSize);
	...
	m_ShipAlpha1A = new wxSlider(Scroll,ID_SHIP_ALPHA_1A,0,0,1,wxDefaultPosition,wxDefaultSize);
	...
	*/
	...
	FlexSizer->Add(TextClassB,0,wxALL|wxALIGN_CENTER_VERTICAL,2);
	FlexSizer->AddSpacer(1);
	FlexSizer->AddSpacer(1);
	...
	m_ShipColor0B = new wxColourPickerCtrl(Scroll,ID_SHIP_COLOR_0B,*wxBLACK,wxDefaultPosition,wxDefaultSize);
	color.Set(GetColor(SHIP_COLOR_0B).R,GetColor(SHIP_COLOR_0B).G,GetColor(SHIP_COLOR_0B).B,GetColor(SHIP_COLOR_0B).A);
	m_ShipColor0B->SetColour(color);
	FlexSizer->Add(m_ShipColor0B,0,wxALL,2);
	m_ShipAlpha0B = new wxSlider(Scroll,ID_SHIP_ALPHA_0B,0,0,1,wxDefaultPosition,wxDefaultSize);
	...
	m_ShipColor1B = new wxColourPickerCtrl(Scroll,ID_SHIP_COLOR_1B,*wxBLACK,wxDefaultPosition,wxDefaultSize);
	color.Set(GetColor(SHIP_COLOR_1B).R,GetColor(SHIP_COLOR_1B).G,GetColor(SHIP_COLOR_1B).B,GetColor(SHIP_COLOR_1B).A);
	m_ShipColor1B->SetColour(color);
	FlexSizer->Add(m_ShipColor1B,0,wxALL,2);
	m_ShipAlpha1B = new wxSlider(Scroll,ID_SHIP_ALPHA_1B,0,0,1,wxDefaultPosition,wxDefaultSize);
	...
	*/
	...
	m_AtonColor = new wxColourPickerCtrl(Scroll,ID_ATON_COLOR,*wxBLACK,wxDefaultPosition,wxDefaultSize);
	...
	m_AtonAlpha = new wxSlider(Scroll,ID_ATON_ALPHA,0,0,1,wxDefaultPosition,wxDefaultSize);
	...
	m_BaseStationColor = new wxColourPickerCtrl(Scroll,ID_BASE_STATION_COLOR,*wxBLACK,wxDefaultPosition,wxDefaultSize);
	...
	m_BaseStationAlpha = new wxSlider(Scroll,ID_BASE_STATION_ALPHA,0,0,1,wxDefaultPosition,wxDefaultSize);
	...
	m_COGColor = new wxColourPickerCtrl(Scroll,ID_COG_COLOR, *wxBLACK,wxDefaultPosition,wxDefaultSize );
	color.Set(GetColor(COG_COLOR).R,GetColor(COG_COLOR).G,GetColor(COG_COLOR).B,GetColor(COG_COLOR).A);
	m_COGColor->SetColour(color);
	...
	m_HDTColor = new wxColourPickerCtrl(Scroll,ID_HDT_COLOR,*wxBLACK,wxDefaultPosition,wxDefaultSize);
	color.Set(GetColor(HDT_COLOR).R,GetColor(HDT_COLOR).G,GetColor(HDT_COLOR).B,GetColor(HDT_COLOR).A);
	m_HDTColor->SetColour(color);
	...
	m_GPSColor = new wxColourPickerCtrl(Scroll,ID_GPS_COLOR,*wxBLACK,wxDefaultPosition,wxDefaultSize);
	color.Set(GetColor(GPS_COLOR).R,GetColor(GPS_COLOR).G,GetColor(GPS_COLOR).B,GetColor(GPS_COLOR).A);
	m_GPSColor->SetColour(color);
